...
- [x] **세션 상태와 UI 동기화**
  - API 응답에 따라 UI 업데이트
  - React Query invalidation으로 자동 갱신
...
- [x] **에러 UI**
  - Toast 알림 (`stores/toastStore.ts`, `components/common/Toast`)
  - 성공/에러 메시지 표시
